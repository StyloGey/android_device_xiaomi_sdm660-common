...
import co.aospa.settings.device.kcal.Utils;
...
public class BootReceiver extends BroadcastReceiver implements Utils {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        FileUtils.setValue(DeviceSettings.NOTIF_LED_PATH, Settings.Secure.getInt(
                context.getContentResolver(), DeviceSettings.PREF_NOTIF_LED, 100) / 100.0
                * (DeviceSettings.MAX_LED - DeviceSettings.MIN_LED) + DeviceSettings.MIN_LED);
        FileUtils.setValue(DeviceSettings.VIBRATION_STRENGTH_PATH, Settings.Secure.getInt(
                context.getContentResolver(), DeviceSettings.PREF_VIBRATION_STRENGTH, 80) / 100.0
