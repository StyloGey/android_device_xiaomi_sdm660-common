...
package co.aospa.settings.device.kcal;
...
import co.aospa.settings.device.FileUtils;
import co.aospa.settings.device.R;
import co.aospa.settings.device.preferences.SecureSettingCustomSeekBarPreference;
    ...
    public boolean onPreferenceChange(Preference preference, Object value) {
        ...
        switch (key) {
            ...
            case PREF_SATURATION:
                if (!(Settings.Secure.getInt(getContext().getContentResolver(), PREF_GRAYSCALE, 0)
                        == 1)) {
