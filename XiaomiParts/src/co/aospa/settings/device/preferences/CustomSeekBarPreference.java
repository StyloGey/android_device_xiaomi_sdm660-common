...
package co.aospa.settings.device.preferences;
...
public class CustomSeekBarPreference extends Preference implements SeekBar.OnSeekBarChangeListener {
    ...
    public void onBindViewHolder(PreferenceViewHolder view) {
        ...
        if (mCurrentValue == mDefaultValue) {
            mStatusText.setText(mDefaultText + mUnits);
        } else {
        ...
        statusTextContainer.setOnClickListener((View v) -> {
            mDialog = new AlertDialog.Builder(getContext())
                    ...
                    .setPositiveButton(android.R.string.ok, (dialog, which) -> {
                        if (mEdit != null) {
                            try {
                                if (Integer.parseInt(mEdit.getText().toString()) >= mMin
                                        && Integer.parseInt(mEdit.getText().toString()) <= mMax) {
